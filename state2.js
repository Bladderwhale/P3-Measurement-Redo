...
demo.state2.prototype = {
    ...
    create: function () {
        ...
        //Text
        this.txtQns = GameInstance.add.text(100-70,100,'What is ' + this.metreNum + ' m ' +  this.cmNumdd + ' cm in centimetres?');
        ...
        this.btnCheck.events.onInputDown.add(function(){
            this.textA.setText(this.metreNum + " m " + this.cmNumdd + " cm");
            ...
            this.textD.setText(this.metreNum*100 + this.cmNumdd*1 + " cm");
            this.cloudtxt.setText("1 m = 100 cm")
            this.cloudtxt1.setText(this.metreNum + " m = " + this.metreNum * 100 + " cm");
            //
            this.textAAA.setText(this.metreNum + " m " + this.cmNumdd + " cm");
            ...
            //
            if (this.txtNum == 4) {
                this.textA.setText(this.metreNum + " m " + this.cmNumd0 + " cm");
                this.textA.position.setTo(this.board.x+320,this.board.y+70);
                this.textB.setText(this.cmNumd0 + " cm");
                this.textC.setText(this.metreNum + " m");
                this.textD.setText(this.metreNum*100 + this.cmNumd0*1 + " cm");
                this.cloudtxt.setText("1 m = 100 cm")
                this.cloudtxt1.setText(this.metreNum + " m = " + this.metreNum * 100 + " cm");
                //
                this.textAAA.setText(this.metreNum + " m " + this.cmNumd0 + " cm");
                this.textAAA.position.setTo(this.board.x+320,this.board.y+70);
                this.textBBB.setText(this.cmNumd0 + " cm");
                this.textCCC.setText(this.metreNum + " m");
            }
            if (this.txtNum == 5) {
                this.textA.setText(this.metreNum + " m " + this.cmNumd + " cm");
                this.textA.position.setTo(this.board.x+320,this.board.y+70);
                this.textB.setText(this.cmNumd + " cm");
                this.textC.setText(this.metreNum + " m");
                this.textD.setText(this.metreNum*100 + this.cmNumd*1 + " cm");
                this.cloudtxt.setText("1 m = 100 cm")
                this.cloudtxt1.setText(this.metreNum + " m = " + this.metreNum * 100 + " cm");
                //
                this.textAAA.setText(this.metreNum + " m " + this.cmNumd + " cm");
                this.textAAA.position.setTo(this.board.x+320,this.board.y+70);
            ...
            if (this.inputNum0.value != 0) {
                ...
                if ((this.inputNum0.value == this.metreNum*100 + this.cmNumdd*1) ||
                (this.inputNum0.value == this.metreNum*100 + this.cmNumd0*1) ||
                (this.inputNum0.value == this.metreNum*100 + this.cmNumd*1))
                 {
                ...
                (this.tryAgainAttempts < 2 && this.inputNum0.value == this.cmNumdd*1 + this.metreNum*10)) {
                    ...
                    this.tween111.onComplete.add(function(){
                        this.textCCC.setText(this.metreNum*100 + " cm");
                        this.tween555.start();
                        this.tween666.start();
                    },this);
        ...
        this.btnShowAnswer.events.onInputDown.add(function(){
            ...
            this.tryAgainAttempts++;
            //
            this.textAA.setText(this.metreNum + " m " + this.cmNumdd + " cm");
            ...
            this.textDD.setText(this.metreNum*100 + this.cmNumdd*1 + " cm");
            this.textEE.setText(this.metreNum*100 + this.cmNumdd*1 + "");
            //
            if (this.txtNum == 4) {
                this.textAA.setText(this.metreNum + " m " + this.cmNumd0 + " cm");
                this.textAA.position.setTo(this.board.x+320,this.board.y+70);
                this.textBB.setText(this.cmNumd0 + " cm");
                this.textCC.setText(this.metreNum + " m");
                this.textDD.setText(this.metreNum*100 + this.cmNumd0*1 + " cm");
                this.textEE.setText(this.metreNum*100 + this.cmNumd0*1 + "");
            }
            if (this.txtNum == 5) {
                this.textAA.setText(this.metreNum + " m " + this.cmNumd + " cm");
                this.textAA.position.setTo(this.board.x+320,this.board.y+70);
                this.textBB.setText(this.cmNumd + " cm");
                this.textCC.setText(this.metreNum + " m");
                this.textDD.setText(this.metreNum*100 + this.cmNumd*1 + " cm");
                this.textEE.setText(this.metreNum*100 + this.cmNumd*1 + "");
            }
            //
            this.tween44.start();
        ...
        this.btnNext.events.onInputDown.add(function(){
            ...
            this.metreNum = mathHelper.metreProperty();
            this.cmNumdd = mathHelper.cmPropertydd();
            this.txtQns.setText('What is ' + this.metreNum + ' m ' +  this.cmNumdd + ' cm in centimetres?');
            this.btnCheck.visible = true;
            this.txtCheck.visible = true;
            this.btnNext.visible = false;
            this.txtNext.visible = false;
            ...
            if (this.txtNum == 4) {
                this.cmNumd0 = mathHelper.cmPropertyd0();
                this.txtQns.setText('What is ' + this.metreNum + ' m ' +  this.cmNumd0 + ' cm in centimetres?');
            }
            if (this.txtNum == 5) {
