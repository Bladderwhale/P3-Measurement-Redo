...
demo.state4.prototype = {
    ...
    create: function () {
        ...
        this.cmNumddd = mathHelper.cmPropertyddd();
        //this.cmNumd0 = mathHelper.cmPropertyd0();
        
        //Text
        this.txtQns = GameInstance.add.text(100-70,100,'What is ' + this.metreNum + ' km ' +  this.cmNumddd + ' m in metres?');
        this.txtQns.addColor('#ff0000',7);
        this.txtQns.addColor('#000000',18);
        this.txtQns.fontSize = 35;
        ...
        this.question1 = GameInstance.add.text(525,230,this.metreNum + '  km  ' + this.cmNumddd + '  m', {fontSize: 22});
        this.question1.addFontWeight('normal',0);
        this.circle = GameInstance.add.sprite(610+20,223,'circle');
        this.circle.scale.setTo(0.07,0.07);
        this.circleAnim = this.circle.animations.add('circleAnim');
        this.circle1 = GameInstance.add.sprite(537+10,223,'circle'); 
        ...
        this.box.drawRect(90,30,100,50);
        this.questionNum = GameInstance.add.text(95,40,'Q' + this.txtNum + " of 5");

        //Prepare for the first segment
        this.inputNum1.visible = false;
        this.txtcm.visible = false;
        this.inputNum0.position.setTo(100,200);
        this.txtM.position.setTo(170+70,210);
        this.txtQns.position.setTo(100-10,100);
        ...
        this.tween88 = GameInstance.add.tween(this.textEE).to({alpha:1},1500,Phaser.Easing.Linear.None).to({x:140,y:210},1500,Phaser.Easing.Linear.None);
        this.rectBox = GameInstance.add.graphics(0,0);
        this.rectBox.lineStyle(1,0x000000,1);
        this.rectBox.beginFill(0x008000,0.2);
        this.rectBox.drawRect(100,200,120,50);
        ...
        this.btnCheck.events.onInputDown.add(function(){
            this.textA.setText(this.metreNum + " km " + this.cmNumddd + " m");
            this.textA.position.setTo(this.board.x+320,this.board.y+70);
            this.textB.setText(this.cmNumddd + " m");
            this.textC.setText(this.metreNum + " km");
            this.textD.setText(this.metreNum*1000 + this.cmNumddd*1 + " m");
            this.cloudtxt.setText("1 km = 1000 m")
            this.cloudtxt1.setText(this.metreNum + " km = " + this.metreNum * 1000 + " m");
            //
            this.textAAA.setText(this.metreNum + " km " + this.cmNumddd + " m");
            this.textAAA.position.setTo(this.board.x+320,this.board.y+70);
            this.textBBB.setText(this.cmNumddd + " m");
            this.textCCC.setText(this.metreNum + " km");
            //
            if (this.txtNum == 2) {
                this.textA.setText(this.metreNum + " km " + this.cmNumdd + " m");
                this.textA.position.setTo(this.board.x+320,this.board.y+70);
                this.textB.setText(this.cmNumdd + " km");
                this.textC.setText(this.metreNum + " km");
                this.textD.setText(this.metreNum*1000 + this.cmNumdd*1 + " m");
                this.cloudtxt.setText("1 km = 1000 m")
                this.cloudtxt1.setText(this.metreNum + " km = " + this.metreNum * 1000 + " m");
                //
                this.textAAA.setText(this.metreNum + " km " + this.cmNumdd + " m");
                this.textAAA.position.setTo(this.board.x+320,this.board.y+70);
                this.textBBB.setText(this.cmNumdd + " m");
                this.textCCC.setText(this.metreNum + " km");
            }
            if (this.txtNum == 3) {
            ...
            if (this.txtNum == 4) {
                ...
                this.cloudtxt1.setText(this.metreNum + " km = " + this.metreNum * 1000 + " m");
                //
                this.textAAA.setText(this.metreNum + " km " + this.cmNumd0 + " m");
                this.textAAA.position.setTo(this.board.x+320,this.board.y+70);
                this.textBBB.setText(this.cmNumd0 + " m");
                this.textCCC.setText(this.metreNum + " km");
            }
            if (this.txtNum == 5) {
                this.textA.setText(this.metreNum + " km " + this.cmNumd + " m");
            ...
            if (this.inputNum0.value != 0) {
                ...
                (this.inputNum0.value == this.metreNum*1000 + this.cmNumdd0*1))
                 {
                    ...
                    this.tween5.onComplete.add(function(){
                        this.textC.setText(this.metreNum*1000 + " m");
                ...
                else if ((this.tryAgainAttempts < 2 && this.inputNum0.value == this.cmNumddd*1 + this.metreNum) || 
                (this.tryAgainAttempts < 2 && this.inputNum0.value == this.cmNumddd*1 + this.metreNum) ||
                (this.tryAgainAttempts < 2 && this.inputNum0.value == this.cmNumdd*1 + this.metreNum)) {
                    this.btnCheck.visible = false;
                    this.txtCheck.visible = false;
                    this.board.alpha = 1;
                    this.tween8.start();
                ...
                else if (this.tryAgainAttempts < 2 && this.inputNum0.value !== this.metreNum*100 + this.cmNumddd*1) {
                    this.btnCheck.visible = false;
                    this.txtCheck.visible = false;
                    this.board.alpha = 1;
                    this.tween444.start();
                    ...
                    this.tween111.onComplete.add(function(){
                        this.textCCC.setText(this.metreNum*1000 + " m");
                        this.tween555.start();
                        this.tween666.start();
                    },this);
        ...
        this.btnShowAnswer.events.onInputDown.add(function(){
            ...
            this.tryAgainAttempts++;
            //
            this.textAA.setText(this.metreNum + " km " + this.cmNumddd + " m");
            this.textAA.position.setTo(this.board.x+320,this.board.y+70);
            this.textBB.setText(this.cmNumddd + " m");
            this.textCC.setText(this.metreNum + " km");
            this.textDD.setText(this.metreNum*1000 + this.cmNumddd*1 + " m");
            this.textEE.setText(this.metreNum*1000 + this.cmNumddd*1 + "");
            //
            if (this.txtNum == 2) {
                this.textAA.setText(this.metreNum + " km " + this.cmNumdd + " m");
                this.textAA.position.setTo(this.board.x+320,this.board.y+70);
                this.textBB.setText(this.cmNumdd + " m");
                this.textCC.setText(this.metreNum + " km");
                this.textDD.setText(this.metreNum*1000 + this.cmNumdd*1 + " m");
            ...
            this.tween66.onComplete.add(function(){
                this.textCC.setText(this.metreNum*1000 + " m");
        ...
        this.btnNext.events.onInputDown.add(function(){
            ...
            //
            this.metreNum = mathHelper.metreProperty();
            this.cmNumddd = mathHelper.cmPropertydd();
            this.txtQns.setText('What is ' + this.metreNum + ' km ' +  this.cmNumddd + ' m in metres?');
            this.btnCheck.visible = true;
            this.txtCheck.visible = true;
            this.btnNext.visible = false;
            this.txtNext.visible = false;
            ...
            if (this.txtNum == 2) {
                this.cmNumdd = mathHelper.cmPropertydd();
                this.question1.setText(this.metreNum + '  km  ' + this.cmNumdd + '  m');
                this.circle.position.setTo(610+10,223);
                this.txtQns.setText('What is ' + this.metreNum + ' km ' +  this.cmNumdd + ' m in metres?');
            }
            if (this.txtNum == 3) {
                this.cmNumd = mathHelper.cmPropertyd();
                this.question1.setText(this.metreNum + '  km  ' + this.cmNumd + '  m');
                this.circle.position.setTo(610+10,223);
